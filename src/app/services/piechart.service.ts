...
export class PiechartService {
  ...
  emotions(element, radius){
        ...
        d3.csv("assets/demo_data/d3/pies/pies_basic.csv", function(error, data) {
            ...
            var tip = d3.tip()
                ...
                .offset([-25, 0])
                .html(function(d) {
                    return "<span class='text-semibold'>" + d.value + " Persons</span>";
                })
  ...
  mostVisSpot(element, radius){
    ...
    d3.csv("assets/demo_data/d3/pies/data.csv", function(error, data) {
